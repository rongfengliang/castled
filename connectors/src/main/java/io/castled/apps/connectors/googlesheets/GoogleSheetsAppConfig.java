...
public class GoogleSheetsAppConfig extends AppConfig {
    ...
    @FormField(type = FormFieldType.TEXT_BOX, title = "Spread Sheet Url", placeholder = "https://docs.google.com/spreadsheets/d/spreadsheetId/edit*", description = "Spread Sheet Id", schema = FormFieldSchema.STRING)
